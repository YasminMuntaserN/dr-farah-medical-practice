            ...
            <div className="space-y-6">
              ...
              <div className={`bg-gradient-to-br ${COLORS.background.earthCard} p-6 rounded-xl border border-stone-200`}>
                ...
                <div className="text-center">
                  <div className="w-24 h-24 bg-beige p-3 rounded-lg shadow-sm mx-auto mb-3 border border-stone-200">
              ...
              <div className={`bg-gradient-to-br ${COLORS.background.cardGradient2} p-6 rounded-xl border border-emerald-100`}>
                ...
                <div className="space-y-3">
                  ...
                  <a
                    ...
                    className={`w-full bg-white border border-emerald-600 ${COLORS.elements.emerald} p-3 rounded-lg font-medium hover:bg-emerald-600 hover:text-beige transition-all duration-200 flex items-center justify-center space-x-2`}
                  >
