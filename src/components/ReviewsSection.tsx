...
const reviewsData = [
  ...
  {
    rating: 5,
    text: "From booking to consultation, the entire experience was smooth and professional. Dr. Farah's expertise in internal medicine is evident, and her warm bedside manner reassured me during my health concerns. The clinic environment is calming and welcoming.",
    author: "Linda K.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:hidden">
            <div className="relative w-full max-w-sm mx-auto">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/60 to-emerald-100/30 group-hover:from-emerald-50/40 to-emerald-100/20 transition-all duration-700 rounded-2xl" />

                <div className="relative z-10">
                  <div className="flex justify-center mb-4">
                    <div className="bg-gradient-to-r from-emerald-500 to-teal-500 w-14 h-14 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500">
                    ...
                    >
                      <div className={`bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl relative overflow-hidden group hover:shadow-2xl transition-all duration-500 h-full flex flex-col ${isMainCard
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                          <div className="flex justify-center mb-4">
                            <div className={`bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500 ${isMainCard ? 'w-14 h-14 lg:w-16 lg:h-16' : 'w-12 h-12'
                              }`}>
